...
public class MenuTestDrive {
    ...
    public static void main(String[] args) {
        ...
        dinnerMenu.add(new MenuItem("채식주의자용 BLT", "통밀 위에 콩고기 베이컨, 상추, 토마토를 얹은 메뉴", true, 2.99));
        ...
        dinnerMenu.add(new MenuItem("찐 채소와 브라운 라이스", "찐 채소와 브라운 라이스의 절묘한 조화",  true, 3.99));
        dinnerMenu.add(new MenuItem("파스타", "마리나라 소스 스파게티. 효모빵도 드립니다.",  false, 3.99));
        ...
        cafeMenu.add(new MenuItem("부리토", "통 핀토콩 살사, 구아카몰이 곁들여진 푸짐한 부리토", true, 4.29));
